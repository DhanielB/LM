  ...
  return (
    <div>
      ...
      <main className="main">
        ...
        <button className="bg-[#5102FB] text-white px-[0.5rem] py-[0.35rem] ml-[1.5rem] mt-[4rem] rounded-md flex justify-center md:block md:justify-center">Quero mandar bem em Matemática em 2023</button>
