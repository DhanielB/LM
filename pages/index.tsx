  ...
  return (
    <div>
      ...
      <main className="main">
        ...
        <div className="right-[-22.5rem] top-[6rem] md:top-[14rem] md:right-[0.5rem] absolute">
          <Image src={require("@/images/main.gif")} alt={""} width={500} height={500}/>
        </div><br/>
        <button className="bg-[#5102FB] text-white px-[0.5rem] py-[0.35rem] ml-[1.5rem] mt-[4rem] rounded-sm">Quero mandar bem em Matemática em 2023</button>
        <a href="https://api.whatsapp.com/send?phone=5531995406293&text=Ol%C3%A1%2C%20estou%20no%20site%20da%20'replica%20do%20LM'%2C%20mas%20gostaria%20de%20fazer%20uma%20pergunta" className="z-10 bg-[#25d366] rounded-[100%] w-[4rem] h-[4rem] pt-[1rem] pl-[1.25rem] bottom-[2.25rem] right-[4.15rem] absolute">
