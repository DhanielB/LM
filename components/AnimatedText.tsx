export default function AnimatedText() {
    return (
        <div className="text-[#5102FB] inline-block pl-[0.20rem]">
            <div className="z-10 inline-block w-[5rem] h-[4.85rem] bg-white absolute"></div>
            <div className="z-10 inline-block mt-[5.95rem] w-[5rem] h-[4.85rem] bg-white absolute"></div>
